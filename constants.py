...
# PL_CLEAR_MODES
CLEAR_NEVER = 0
CLEAR_PRE_EXPOSURE = CLEAR_NEVER + 1
...
MAX_EXPOSE_OUT_MODE = EXPOSE_OUT_ROLLING_SHUTTER + 1
...
### ADDED BY HAND. LAST UPDATED: 2017-07-26 ###
...
clear_mode_name = {val: key for key, val in clear_modes.items()}
exp_resolutions = {0: EXP_RES_ONE_MILLISEC, 1: EXP_RES_ONE_MICROSEC, 2: EXP_RES_ONE_SEC}
exp_resolutions_name = {val: key for key, val in exp_resolutions.items()}
...
exp_mode_name = {val: key for key, val in exp_modes.items()}
